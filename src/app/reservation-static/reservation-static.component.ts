...
@Component({
  selector: 'app-reservation-static',
  templateUrl: './reservation-static.component.html',
  styleUrls: ['./reservation-static.component.css']
})
export class ReservationStaticComponent implements OnInit,AfterViewInit {
