...
const routes: Routes = [
  ...
  {path:  "", component: MainComponent,  canActivate: [AuthGuard],
    children: [
      ...
      {path: "house-keeping/:site_id/room", component:RoomComponent, canActivate: [AuthGuard] },
      {path: "house-keeping/:site_id/room/:room_id", component:RoomComponent, canActivate: [AuthGuard] },
